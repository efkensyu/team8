...
//
//@Controller
//public class Team8_newwwwwwwTemplate {
//	@GetMapping("/team8_3-2")
//	public String index(@ModelAttribute("empForm") Team8_EmpFormTemplate empForm) {
//		System.out.println("indexメソッド実行");
//		return "team8/team8_question3-2";
//	}
//	
//	@PostMapping(value = "/team8_3-2", params = "next")
//	public String send1(@ModelAttribute("empForm") @Validated Team8_EmpFormTemplate empForm, BindingResult result) {
//		
//		if (result.hasErrors()) {
//			return "team8/team8_question3-2";
//		}
